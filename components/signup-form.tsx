...
import { authenticate, handleGoogleLogin } from '@/app/login/actions'
...
export default function SignupForm() {
  ...
  const handleGoogleLoginClick = async (event: React.MouseEvent<HTMLButtonElement>) => {
  ...
  return (
    ...
    >
      <div className="w-full flex-1 rounded-lg border bg-white px-6 pb-4 pt-8 shadow-md md:w-96 dark:bg-zinc-950">
        ...
        <Link href=""
        className="flex flex-row gap-1 text-sm text-zinc-400 justify-center items-center">
